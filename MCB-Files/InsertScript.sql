...
-- Quotes
 insert into quote(QuoteText, Author, CompanyId, CreatedOn)
	...
	,'Steven Wright', @companyId, current_timestamp());
insert into quote(QuoteText, Author, CompanyId, CreatedOn)
...
VALUES ('Prijatan ambijent','Posjetite nas!', @companyId, current_timestamp());
...
INSERT INTO `mastercraftbrewery`.`gallery`
(`Name`, `Description`, `CompanyId`, `CreatedOn`)
VALUES ('Dr Nele Karajlić','Promocija knjiga Fajront u Sarajevu i Solunska 28 i nezaboravno druženje', @companyId, current_timestamp());
set @galleryId = last_insert_id();
...
INSERT INTO `mastercraftbrewery`.`gallery`
(`Name`, `Description`, `CompanyId`, `CreatedOn`)
VALUES ('Festival zanatskog piva','Osvojeno prvo mjesto!', @companyId, current_timestamp());
set @galleryId = last_insert_id();
...
INSERT INTO `mastercraftbrewery`.`gallery`
(`Name`, `Description`, `CompanyId`, `CreatedOn`)
VALUES ('KAKO MI TO RADIMO...','Pogledajte proces proizvodnje u nekoliko koraka :-)', @companyId, current_timestamp());
set @galleryId = last_insert_id();
